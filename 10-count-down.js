...
***********************************************************************/
//Declares a function that accepts a number as an argument, and returns a function that decrements the number with each call.
//Returns "Happy New Year!" if the initial argument is strictly equal to 0, or when the decremented 'num' is less than or equal to 0.
