...
***********************************************************************/
//Declares a function that returns a 'count' variable incremented by 1 each time it is invoked.  This function accepts no arguments.
function hiddenCounter() {
  let count = 0;
  return function nestedCounter() {
    count++;
    return count;
  };
}
