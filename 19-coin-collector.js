...
***********************************************************************/
//Declares a function that takes a number of 'coins' as an argument.  Returns a function that accepts a single 'coin' as an argument and pushes it to an empty 'coinArray' when invoked.
//Returns coinArray when its length equals numCoins.
function coinCollector(numCoins) {
  let coinArray = [];
  return function coinCollection(coin) {
    coinArray.push(coin);
