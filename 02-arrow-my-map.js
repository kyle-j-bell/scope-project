...
***********************************************************************/
//Declares a function using arrow function syntax.  Accepts an array and a callback.
//Declares an empty newArray, and uses Array.forEach to iterate through the argument array, pushing the result of each element passed through the callback to newArray.
//Returns newArray.
const arrowMyMap = (array, cb) => {let newArray = []; array.forEach(element => newArray.push(cb(element))); return newArray};
